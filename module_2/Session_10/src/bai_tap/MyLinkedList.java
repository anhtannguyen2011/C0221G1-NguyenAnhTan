...
public class MyLinkedList<E> {
    ...
    public void addFirst(E element){
        ...
        Node temp = head;
        //Biến head sẽ nhận giá trị 1 node mới;
    ...
    public void add(int index,E element){
        ...
        temp.next = new Node(element);
        //Node mới này sẽ trở đến holder
    ...
    public boolean remove(E element){
        ...
        if(head.data.equals(element)){
            ...
            Node temp = head;
            while (temp.next != null){
                //Nếu như tồn tại i phần tử có data bằng data truyền vào thì node đó sé remove;
    ...
    public MyLinkedList<E> clone(){
        ...
        if(numNodes == 0){
            throw new NullPointerException("Linked Líst này null");
        }
    ...
    public boolean constranins(E elements){
        Node temp = head;
        while (temp.next != null){
