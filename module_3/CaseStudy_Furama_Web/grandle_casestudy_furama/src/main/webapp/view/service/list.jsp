...
<div class="header-link">
    ...
    <nav class="navbar navbar-light bg-light">
        <form class="form-inline" style="margin-top: 0px" method="post" action="/services?action=search">
...
<div class="container-fluid mt-5 border border-body">
    ...
    <table class="table table-striped table-bordered" style="width:100%" id="tableStudent">
        ...
        <tr>
            ...
            <th>Service Area</th>
            <th>Service Cost</th>
            <td class="text-center"><a href="/services?action=create" style="font-size: 20px; text-decoration: none"><i class="fas fa-plus-circle"></i>Add</a></td>
        </tr>
        </thead>
        <tbody>
        <c:forEach items="${serviceList}" var="service">
            <tr>
                ...
                <td>
                    <a href="/services?action=edit&id=${service.serviceId}"
                       class="btn btn-outline-info">Edit</a>
                    <button onclick="setIdDelete(${service.serviceId})" type="button" class="btn btn-outline-danger" data-toggle="modal" data-target="#exampleModal">
                        Delete
                    </button>
