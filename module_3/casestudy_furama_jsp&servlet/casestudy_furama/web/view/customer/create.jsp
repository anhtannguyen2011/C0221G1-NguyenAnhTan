                    ...
                    <div class="row gutters row__start">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                            <div class="form-group">
                                ...
                                <input name="day_of_birth" type="text" class="form-control" id="phone" placeholder="Enter Day Of Birth">
                            </div>
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                            <div class="form-group">
                                <label for="website">ID Card</label>
                                <input name="id_card" type="text" class="form-control" id="website" placeholder="ID Card">
                            </div>
                        </div>
                    </div>
                    <div class="row gutters row__start">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                            <div class="form-group">
                                ...
                                <input name="phone" type="text" class="form-control" id="Street" placeholder="Phone">
                            </div>
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                            <div class="form-group">
                                <label for="ciTy">Email</label>
                                <input name="email" type="text" class="form-control" id="ciTy" placeholder="Enter Email">
                            </div>
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                            <div class="form-group">
                                <label for="sTate">Address</label>
                                <input name="address" type="text" class="form-control" id="sTate" placeholder="Enter Address">
                            </div>
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                            <div class="form-group">
                                <label for="zIp">ID Customer Type</label>
                                <input name="id_loai_khach" type="text" class="form-control" id="zIp" placeholder="ID Customer Type">
                            </div>
                        </div>
                    </div>
                    <div class="row gutters row__start">
